...
import 'package:vending/src/constants/security_questions.dart';
...
import 'package:vending/src/widgets/md_widget/custom_divider.dart';
...
class _AddUserFormState extends State<AddUserForm> {
  ...
  Future handleSubmit(BuildContext context) async {
    ...
    if (imagePath != null &&
      ...
      var resulst = await DatabaseHelper.instance.createUser(context, {
