...
import 'package:vending/src/constants/initail_store.dart';
...
import 'package:vending/src/widgets/login_widget/login_button.dart';
...
class _LoginBodyWidgetState extends State<LoginBodyWidget> {
  ...
  void login() async {
    if (userName.text.isEmpty || userPassword.text.isEmpty) {
      ScaffoldMessage.show(context, 'กรุณาป้อนชื่อผู้ใช้และรหัสผ่าน', false);
      setState(() {
        isLoading = false;
      });
      return;
