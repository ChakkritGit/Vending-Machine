...
import 'package:vending/src/screens/add_inventory.dart';
import 'package:vending/src/widgets/md_widget/floating_button.dart';
              ...
              onPressed: () async {
                ...
                if (resulst) {
                  ScaffoldMessage.show(
                      context, 'ช่องที่ $inventoryPosition ถูกลบแล้ว', false);
